...
const Projects = () => {
  return (
    <div id="projects" className='px-6 py-12 flex justify-center items-center font-Cabin text-[#f3f4f6]'>
      <div className='bg-[#363636] rounded py-6 px-6 rounded-2xl text-center grid grid-cols-2 gap-4 place-items-center mx-20 max-w-5xl md:mx-20 mx-4'>
        <h1 className="text-6xl py-6 px-6 text-color5 col-span-2 font-Kanit rounded-2xl">
          Projects
          <hr className='border-2 mt-3 mx-8 text-color5 opacity-10'/>
        </h1>
        <div>
          <a href="https://github.com/MikkMaltis/2023-9.20.2023-projekt" className="hover:underline hover:text-color9">
        ...
        <div>
          <a href="https://github.com/MikkMaltis/Tailwind-website-with-templates" className="hover:underline hover:text-color9">
          ...
          <a href="https://github.com/MikkMaltis/Ai-startup-tool" className="hover:underline hover:text-color9">
          ...
          <a href="https://github.com/MikkMaltis/Apple" className="hover:underline hover:text-color9">
